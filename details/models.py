...
# GLYCOSYLATED HEMOGLOBIN (HBA1c)
    ...
    hba1c_reference_range = models.CharField(max_length=50, blank= True)
...
# RANDOM BLOOD SUGAR
    ...
    random_blood_sugar_reference_range = models.CharField(max_length=50, blank=True)
# RFT/KFT
    uric_acid = models.CharField(max_length=10, blank=True)
    uric_acid_unit = models.CharField(max_length=10, blank=True)
    uric_acid_reference_range = models.CharField(max_length=50, blank=True)
    ...
    serum_creatinine_reference_range = models.CharField(max_length=50, blank=True)
# LIPID PROFILE
...
# LIVER FUNCTION TEST
    ...
    direct_bilirubin_reference_range = models.CharField(max_length=50, blank=True)
    ...
    indirect_bilirubin_reference_range = models.CharField(max_length=50, blank=True)
    ...
    globulin_reference_range = models.CharField(max_length=50, blank=True)

    alb_glob_ratio = models.CharField(max_length=10, blank=True)
    alb_glob_ratio_unit = models.CharField(max_length=10, blank=True)
    alb_glob_ratio_reference_range = models.CharField(max_length=50, blank=True)

    ggtp = models.CharField(max_length=10, blank=True)
    ggtp_unit = models.CharField(max_length=10, blank=True)
    ggtp_reference_range = models.CharField(max_length=50, blank=True)

class HB(models.Model):
    # hb = models.CharField(max_length=10, blank= True)
    hb_unit = models.CharField(max_length=10, blank= True)
    hb_reference_range = models.CharField(max_length=150, blank= True)
    # def __str__(self):
    #     return self.location
